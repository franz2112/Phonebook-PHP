...
<body style="background-color: #ffe2c9;">
  ...
  <!-- main page -->
          ...
          <div class="search-menu">
            ...
            <div class="field">
              <a href="searchcountry.php" class="button ice" role="button">Search by Country</a>
              <a href="searchsurname.php" class="button ice" role="button">Search by Surname</a>
              <a href="index.php" class="button ice" role="button">Back To Main Menu</a>
            </div>
            </div>
          </div>
